...
async function main() {
    ...
    drawScene(gl, program, positionLocation, resolutionLocation, colorLocation, positionBuffer);
...
function drawScene(gl, program, positionLocation, resolutionLocation, colorLocation, positionBuffer) {
