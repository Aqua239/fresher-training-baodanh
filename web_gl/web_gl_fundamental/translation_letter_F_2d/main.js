...
async function main() {
    ...
    setGeometry(gl);
    drawScene(gl, program, positionLocation, resolutionLocation, colorLocation, translationLocation, positionBuffer);
...
function drawScene(gl, program, positionLocation, resolutionLocation, colorLocation, translationLocation, positionBuffer) {
